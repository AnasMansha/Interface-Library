...
int DisplayBoxWithMultilineStr(int row, int column, int width, int height, char border, string Str, string str_color = "default", string border_color = "default", char fill = ' ', string fill_color = "Black", bool Text_In_Middle = true);
