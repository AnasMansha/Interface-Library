...
int DisplayBoxWithMultilineStr(int row, int column, int width, int height, char border, string Str, string str_color, string border_color, char fill, string fill_color, bool Text_In_Middle)
{
